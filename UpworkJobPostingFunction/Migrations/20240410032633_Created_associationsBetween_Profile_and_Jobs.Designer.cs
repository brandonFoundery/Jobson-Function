...
namespace Jobson.Migrations
{
    ...
    [Migration("20240410032633_Created_associationsBetween_Profile_and_Jobs")]
    partial class Created_associationsBetween_Profile_and_Jobs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UpworkJobPostingFunction.Models.Job", b =>
                {
                    ...
                    b.Property<int>("UpworkProfileId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UpworkJobPostingFunction.Models.TrelloBoard", b =>
                {
            ...
            modelBuilder.Entity("UpworkJobPostingFunction.Models.Job", b =>
                {
                    ...
                    b.HasOne("UpworkJobPostingFunction.Models.UpworkProfile", "UpworkProfile")
                        .WithMany("Jobs")
            ...
            modelBuilder.Entity("UpworkJobPostingFunction.Models.UpworkProfile", b =>
                {
                    ...
                    b.HasOne("UpworkJobPostingFunction.Models.TrelloBoard", "TrelloBoard")
                        .WithMany()
